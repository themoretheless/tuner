...
| G2 | P0 | Make release metrics tuner-specific: time-to-first-correct, false-lock duration, reacquisition latency, note switches/second and stable-sustain cents MAE by scenario. | Promotes `X1-X2`, extending `M61/M94`; average cents alone hides the exact "chaos" users report. |
