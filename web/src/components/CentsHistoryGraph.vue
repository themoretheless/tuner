...
<template>
  <div class="w-full max-w-[420px]">
    ...
    <svg viewBox="0 0 100 40" class="h-14 w-full rounded-lg border border-slate-800 bg-[#0f1319]" preserveAspectRatio="none" role="img" :aria-label="t('visual.history.label')">
