...
Полный backlog того, что ещё сделано неправильно или плохо на текущий момент, находится в [recommendation.md](recommendation.md). Сейчас там 182 нерешённых пункта после удаления уже исправленного и неактуального.
